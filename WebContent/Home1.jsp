...
<html lang="en">
  ...
  <body class="index" id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
          <li class="nav-item">
            <a class="nav-link" href="CreateModule.jsp">Create Module</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="ModuleRegisterAndFetchServlet?viewName=viewModule">View Module</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="ModuleRegisterAndFetchServlet?updateForm=updateModule">Edit Module</a>
          </li>
        </ul>
      </div>
    </nav>
    ...
    <section class="success" id="about">
      <div class="container">
        <h2 class="text-center">View Module</h2>
        <hr class="star-light">
        <div class="row">
